...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, hideNavigation = false }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex">
      {!hideNavigation && <Sidebar isCollapsed={isCollapsed} onToggle={() => setIsCollapsed(!isCollapsed)} />}
      <div className={`flex-1 flex flex-col transition-all duration-300 ${hideNavigation ? 'ml-0' : isCollapsed ? 'ml-20' : 'ml-64'}`}>
        {/* Header */}
        {!hideNavigation && (
